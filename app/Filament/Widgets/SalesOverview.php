...
class SalesOverview extends BaseWidget
{
    ...
    {
        return [
            \Filament\Widgets\StatsOverviewWidget\Stat::make('Total Invoice', 'Rp ' . number_format(\App\Models\Sale::sum('grand_total'), 0, ',', '.'))
                ->description('Total pendapatan dari semua invoice')
